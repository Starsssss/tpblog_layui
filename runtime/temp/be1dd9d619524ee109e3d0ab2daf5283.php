<?php /*a:1:{s:76:"C:\phpstudy_pro\WWW\www.tp.layui.com\application\admin\view\login\index.html";i:1604225552;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div id="container">
    ...
    <div class="admin-login-background">
        ...
        <form class="layui-form" >
            ...
            <div>
                <input type="text" name="captcha1" placeholder="请输入验证码" autocomplete="off" class="layui-input admin-input admin-input-verify input-val" value="">
                <!--<canvas id="canvas" class="admin-captcha" width="100" height="43"></canvas>-->
                <div class="admin-captcha"><img src="<?php echo captcha_src(); ?>" alt="captcha" id="captcha" onclick="change(this)" width="90px" height="40px" /></div>
            </div>
