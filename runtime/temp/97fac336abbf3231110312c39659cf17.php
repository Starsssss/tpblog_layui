<?php /*a:1:{s:76:"C:\phpstudy_pro\WWW\www.tp.layui.com\application\index\view\login\index.html";i:1604306398;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <style>
        ...
        .login-main .login-bottom .center .item .icon-1 {background:url(/static/home/images/icon-login.png) no-repeat 1px 0;}
        .login-main .login-bottom .center .item .icon-2 {background:url(/static/home/images/icon-login.png) no-repeat -54px 0;}
        .login-main .login-bottom .center .item .icon-3 {background:url(/static/home/images/icon-login.png) no-repeat -106px 0;}
        .login-main .login-bottom .center .item .icon-4 {background:url(/static/home/images/icon-login.png) no-repeat 0 -43px;position:absolute;right:-10px;cursor:pointer;}
        .login-main .login-bottom .center .item .icon-5 {background:url(/static/home/images/icon-login.png) no-repeat -55px -43px;}
        .login-main .login-bottom .center .item .icon-6 {background:url(/static/home/images/icon-login.png) no-repeat 0 -93px;position:absolute;right:-10px;margin-top:8px;cursor:pointer;}
        ...
        .login-main .login-bottom .tip .icon-check {margin:0 7px 0 0;width:14px;height:14px;border:none;background:url(/static/home/images/icon-login.png) no-repeat -111px -48px;}
        ...
        body {background:url(/static/home/images/loginbg.png) 0% 0% / cover no-repeat;position:static;font-size:12px;}
        ...
        <form class="layui-form login-bottom">
            <div class="center">
                ...
                <div id="validatePanel" class="item" style="width: 137px;">
                    ...
                    <img id="refreshCaptcha" class="validateImg" onclick="change(this)" src="<?php echo captcha_src(); ?>" alt="captcha" />" >
                </div>
        ...
        form.on('submit(login)', function (data) {
            ...
            $.ajax({
                ...
                success:function (data) {
                    // layer.msg(msg);
                    if (data.code==1){
                        layer.msg('登录成功', {time:3000, icon: 1},function () {
                            window.location = '<?php echo url("index/index/index"); ?>';
                        });

                    }
                    else layer.msg(data.msg,{time:3000, icon: 2})
                }
            });
...
<script>
    function change(obj) {
        obj.src= '<?php echo captcha_src(); ?>'+Math.random();
    }
</script>
